...
import { useManageScenarists } from '@/hooks/manage/scenarists/useManageScenarists'
import { FC } from 'react'
import styles from '../../ManagePages.module.scss'

const ManageScenarists: FC = () => {
	const {
		searchTerm,
		data,
		handleSearch,
...
export default ManageScenarists
