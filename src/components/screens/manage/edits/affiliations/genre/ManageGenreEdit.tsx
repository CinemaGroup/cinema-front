...
import { useManageGenreEdit } from '@/hooks/manage/genres/useManageGenreEdit'
...
const ManageGenreEdit: FC<{ queryId: string }> = ({ queryId }) => {
	const { control, setValue, handleSubmit } = useForm<TypeAffiliationInput>({
		mode: 'onChange',
	})

	const { onSubmit } = useManageGenreEdit(queryId, setValue)
...
export default ManageGenreEdit
