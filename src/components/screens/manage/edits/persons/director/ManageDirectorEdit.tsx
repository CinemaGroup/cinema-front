...
import { useManageDirectorEdit } from '@/hooks/manage/directors/useManageDirectorEdit'
import { TypePersonInput } from '@/services/persons/types/persons.type'
import { FC } from 'react'
import { Controller, useForm } from 'react-hook-form'
import styles from '../ManagePersons.module.scss'

const ManageDirectorEdit: FC<{ queryId: string }> = ({ queryId }) => {
	const { control, setValue, handleSubmit } = useForm<TypePersonInput>({
		mode: 'onChange',
	})

	const { onSubmit } = useManageDirectorEdit(queryId, setValue)
...
export default ManageDirectorEdit
