...
import { useManageScenaristEdit } from '@/hooks/manage/scenarists/useManageScenaristEdit'
import { TypePersonInput } from '@/services/persons/types/persons.type'
import { FC } from 'react'
import { Controller, useForm } from 'react-hook-form'
import styles from '../ManagePersons.module.scss'

const ManageScenaristEdit: FC<{ queryId: string }> = ({ queryId }) => {
	const { control, setValue, handleSubmit } = useForm<TypePersonInput>({
		mode: 'onChange',
	})

	const { onSubmit } = useManageScenaristEdit(queryId, setValue)
...
export default ManageScenaristEdit
