...
import { useManageOperatorEdit } from '@/hooks/manage/operators/useManageOperatorEdit'
import { TypePersonInput } from '@/services/persons/types/persons.type'
import { FC } from 'react'
import { Controller, useForm } from 'react-hook-form'
import styles from '../ManagePersons.module.scss'

const ManageOperatorEdit: FC<{ queryId: string }> = ({ queryId }) => {
	const { control, setValue, handleSubmit } = useForm<TypePersonInput>({
		mode: 'onChange',
	})

	const { onSubmit } = useManageOperatorEdit(queryId, setValue)
...
export default ManageOperatorEdit
