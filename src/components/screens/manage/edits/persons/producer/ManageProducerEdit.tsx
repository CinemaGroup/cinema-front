...
import { useManageProducerEdit } from '@/hooks/manage/producers/useManageProducerEdit'
import { TypePersonInput } from '@/services/persons/types/persons.type'
import { FC } from 'react'
import { Controller, useForm } from 'react-hook-form'
import styles from '../ManagePersons.module.scss'

const ManageProducerEdit: FC<{ queryId: string }> = ({ queryId }) => {
	const { control, setValue, handleSubmit } = useForm<TypePersonInput>({
		mode: 'onChange',
	})

	const { onSubmit } = useManageProducerEdit(queryId, setValue)
...
export default ManageProducerEdit
